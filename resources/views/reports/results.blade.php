...
<section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <br/>
        <div>
          <h2>Reports with similar face</h2>
        </div>
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                
                @foreach($photos as $key=>$report)<div class="col-lg-4 col-md-6 portfolio-item filter-app">
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200"> {!! $photos->appends(\Request::except('page'))->render() !!} </div>
        <br/>

        <div>
          <h2>Reports with similar Data</h2>
        </div>
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">

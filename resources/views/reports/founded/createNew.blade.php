      ...
      <div class="container">
        ...
        <div class="col-lg-4">
            ...
            <div class="col-lg-8 mt-5 mt-lg-0">
                ...
                <form method="POST" action="{{ route('reports.store') }}" enctype="multipart/form-data" data-aos="fade-left">
                    @csrf
                    <hr/>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <textarea id="special_characterstics" type="text" class="form-control" name="special_characterstics" value="{{ old('special_characterstics') }}" placeholder="Some distinguishing features in case they exist ... such as: blind, burning in the face, mentally disturbed" style="margin-top: 0px; margin-bottom: 0px; height: 100px;"></textarea>
                        </div>
                    </div>

...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Report For A Missed One') }}</div>
                ...
                <div class="card-body">
                    <form method = "POST" action="{{route('welcome')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="full_name" type="text" class="form-control" name="full_name" value="{{ old('full_name') }}" required autocomplete="full_name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="father_name" type="text" class="form-control" name="father_name" value="{{ old('father_name') }}" required autocomplete="father_name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="birth_date" type="date" class="form-control " name="birth_date" value="{{ old('birth_date') }}" required autocomplete="birth_date">
                        ...
                        <div class="form-group row">
                            <input name="state" value="MISSED" type="hidden">                           
                        </div>

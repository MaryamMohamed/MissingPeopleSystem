            ...
            <?php if(Route::has('login')): ?>
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/profiles', auth()->user())); ?>" class="text-sm text-gray-700 underline">Profiles</a>
...
<?php /**PATH E:\college\level.4\GP\GraduationProjectV1.1\MissingPeopleSystem\resources\views/welcome.blade.php ENDPATH**/ ?>